<template>
  <div class="registration">
    ...
    <h3 class="text-capitalize title text-center">check code</h3>
    ...
    <div class="container">
      ...
      >
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-input d-block" v-model="code" />
          <div class="validations-errors">
            <span v-if="!$v.code.required && $v.code.$dirty" class="text-danger"
  ...
  methods: {
    checkCode() {
      ...
      if (this.$v.$invalid) {
        ...
        this.loading = true;
        let payload = { email: this.email, code: this.code };
        this.$store
